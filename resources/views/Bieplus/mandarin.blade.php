...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/mandarinbieplus.css') }}">
    {{--
...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-text">
            ...
            <p data-aos="fade-up" data-aos-delay="200">Kuasai bahasa Mandarin dengan metode interaktif dan pengajar
                berpengalaman.</p>
        </div>
    </section>
                            ...
                            <div class="program-card h-100 d-flex flex-column">
                                ...
                                <div class="program-card-content d-flex flex-column flex-grow-1">
                                    ...
                                    <a href="{{ route('public.program.offline.show', $program->slug) }}"
                                        class="program-btn w-100 mt-auto">
                                        Lihat Detail
                                    </a>
                                </div>
                            </div>
        ...
        <div class="container" data-aos="fade-up"> {{-- PENAMBAHAN: Animasi untuk kontainer utama --}}
            ...
            <div class="contact-card mt-5" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="contact-links">
                    <a href="https://wa.me/6282143120833?text=Halo%2C%20saya%20tertarik%20dengan%20kursus%20Mandarin%20di%20Pare."
                        class="contact-link">
